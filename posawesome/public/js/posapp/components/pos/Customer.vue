<template>
  <div>
    <v-autocomplete
      ...
      @click:append="handle_open_customer_dialog"
      ...
      <template v-slot:item="data">
        <template>
          <v-list-item-content>
            ...
            ></v-list-item-subtitle>
            <v-list-item-subtitle
              v-if="data.item.custom_first_mobile"
              v-html="`Mobile No: ${data.item.custom_first_mobile}`"
            ></v-list-item-subtitle>
            <v-list-item-subtitle
...
export default {
  ...
  methods: {
    ...
    customFilter(item, queryText, itemText) {
      const textOne = item.custom_first_mobile
        ? item.custom_first_mobile
        : '';
